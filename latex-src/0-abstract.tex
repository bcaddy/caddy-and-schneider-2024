...
% S5: Scaling
We employ GPU direct MPI to attain nearly perfect weak scaling on up to 74,000 GPUs while simulating a total grid size of over 1.2 trillion cells.
...
We also present new testing and continuous integration tools for Cholla that utilize GoogleTest, GitHub Actions, and Jenkins which have helped make Cholla more robust and accurate.
% S9:  
