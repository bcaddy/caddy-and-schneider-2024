...
\begin{table}
    \caption*{\textbf{Riemann Problem Initial Conditions.}}
    ...
    \end{tabular}
    \caption{The $L/R$ subscripts indicate that it is the left/right state. $B_x$ is always the same in both states.}
    \label{table:riemann}
\end{table}
