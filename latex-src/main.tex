...
\begin{abstract}
    ...
    % S5: Scaling
    We employ GPU direct MPI to attain nearly perfect weak scaling on the exascale supercomputer \textit{Frontier}, while using \textbf{over} 74,000 GPUs and simulating a total grid size of over \textbf{7}.2 trillion cells.
