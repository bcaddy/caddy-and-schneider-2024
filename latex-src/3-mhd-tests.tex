...
These Alfv\'en waves are subject to a parametric instability (TODO cite Del Zanna, Velli, \& Londrillo, A\&A 367, 705, 2001) which should not be present for these initial conditions. However, the truncation error will result in small variations in the magnetic pressure which will drive low amplitude compression waves \citep{stone_athena_2008}. 
